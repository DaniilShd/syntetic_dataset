...
def main():
    ...
    parser.add_argument("--clean_dir", type=str, default="data/640x640/clean_patches")
    parser.add_argument("--output_dir", type=str, default="results/640x640/synthetic_backgrounds")
